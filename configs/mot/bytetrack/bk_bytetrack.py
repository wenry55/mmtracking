...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='CocoDataset',
            ann_file=[
                '/raid/templates/data/bkseo/cow/annotations/instances_Train.json',
                '/raid/templates/data/bkseo/cow/annotations/instances_Validation.json',
                '/raid/templates/data/bkseo/cow/annotations/instances_Validation.json'
            ],
            img_prefix=[
                '/raid/templates/data/bkseo/cow/images',
                '/raid/templates/data/bkseo/cow/images',
                '/raid/templates/data/bkseo/cow/images'
            ],
            classes=('hanwoo', ),
...
data_root = '/raid/templates/data/bkseo/cow/'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
